...
def main():
    ...
    # HR images
    opt['input_folder'] = 'datasets/train_HR'
    opt['save_folder'] = 'datasets/train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = 'datasets/train_LR_bicubic/X4'
    opt['save_folder'] = 'datasets/train_LR_bicubic/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
